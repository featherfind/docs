...
\usepackage[nolist, nosection]{acro} %for List of Abbrreviation and Symbol
...
\ifhassupervisor % Displays Supervisor name only if \hassupervisortrue
	...
	\large{\textbf{\degSup}}\\
	%\large{\textbf{\degSupSecondline}}\\
	%\large{\textbf{\degSupThirdline}}
\fi
\vfill	%vertically fill the space 
...
\begin{center}
\fontsize{12.8pt}{1} %size decreased to adjust department name in single line
\textbf{
...
\submittedBy
in partial fulfillment for the degree of \degree. 
\vspace{25pt}
% \par
{
\begin{table}[H]
\begin{flushleft}
	\begin{tabular}{@{}p{0.45\textwidth}@{}p{0.1\textwidth}@{}p{0.45\textwidth}@{}}
		...
		\begin{minipage}[t]{0.45\textwidth}
			...
			\hod \\
			\degHod \\
			\text{Kantipur Engineering College} \\
			 \\
			\
		\end{minipage} \\
	\end{tabular}
...
\textbf{cGAN} \> Conditional Generative Adversarial Network\\
...
%{
%\singlespacing
%\printacronyms[include = symbol, name= ]
%}
%}
