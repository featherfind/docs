...
\begin{itemize}
    \item \textbf{Silence Gap Removal:} After observing some of the data samples, it was found that the audio has some silence gaps
     in either of the ends as seen in \ref{fig:SampleData}. These could be removed employing the silence removal algorithm. The processing
...
\begin{figure}[h!]
     \centering
        ...
        \caption{Usecase Diagram for FeatherFind}%\label{fig:fig1}
     \end{figure}
